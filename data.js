...
const QUESTIONS_HISTOIRE = [
    ...
    // --- Questions histoire/géo supplémentaires niveau CEB ---
    { q: "Quel est le chef-lieu de la province de Hainaut ?", choices: ["Charleroi", "Mons", "Tournai", "La Louvière"], correct: 1, explanation: "Mons est le chef-lieu du Hainaut." },
    { q: "Quel est le chef-lieu de la province de Liège ?", choices: ["Verviers", "Liège", "Spa", "Eupen"], correct: 1, explanation: "Liège est le chef-lieu de la province de Liège." },
    { q: "Quel est le chef-lieu de la province du Brabant wallon ?", choices: ["Waterloo", "Nivelles", "Wavre", "Ottignies"], correct: 2, explanation: "Wavre est le chef-lieu du Brabant wallon." },
    { q: "Quel est le chef-lieu de la province de Namur ?", choices: ["Dinant", "Namur", "Rochefort", "Philippeville"], correct: 1, explanation: "Namur est le chef-lieu de la province de Namur." },
    { q: "Quel est le chef-lieu de la province de Luxembourg ?", choices: ["Arlon", "Bastogne", "Marche-en-Famenne", "Virton"], correct: 0, explanation: "Arlon est le chef-lieu de la province de Luxembourg." },
    { q: "Quelle est la fête nationale de la Belgique ?", choices: ["Le 14 juillet", "Le 21 juillet", "Le 1er août", "Le 11 novembre"], correct: 1, explanation: "Le 21 juillet, anniversaire de la prestation de serment de Léopold Ier en 1831." },
    { q: "Combien de communautés y a-t-il en Belgique ?", choices: ["2", "3", "4", "5"], correct: 1, explanation: "3 communautés : française, flamande et germanophone." },
    { q: "Quelle bataille célèbre s'est déroulée près de Waterloo en 1815 ?", choices: ["La bataille de Verdun", "La bataille de Waterloo", "La bataille de Hastings", "La bataille de Stalingrad"], correct: 1, explanation: "Napoléon y a été vaincu par les armées de Wellington et Blücher." },
    { q: "Le Congo a été une colonie belge. En quelle année est-il devenu indépendant ?", choices: ["1945", "1955", "1960", "1975"], correct: 2, explanation: "Le Congo belge est devenu indépendant le 30 juin 1960." },
    { q: "Quel roi belge a régné sur le Congo comme propriété personnelle ?", choices: ["Léopold Ier", "Léopold II", "Albert Ier", "Baudouin"], correct: 1, explanation: "Léopold II possédait le Congo à titre personnel avant qu'il ne devienne colonie belge." },
    { q: "Comment s'appelle le parlement européen qui siège à Bruxelles ?", choices: ["Le Sénat", "Le Conseil de l'Europe", "Le Parlement européen", "L'Assemblée nationale"], correct: 2, explanation: "Le Parlement européen siège à Bruxelles et Strasbourg." },
    { q: "Combien de pays font partie de l'Union européenne en 2025 (environ) ?", choices: ["12", "20", "27", "35"], correct: 2, explanation: "27 pays membres depuis le départ du Royaume-Uni en 2020." },
    { q: "Quelle monnaie est utilisée dans la plupart des pays de l'Union européenne ?", choices: ["Le dollar", "La livre", "L'euro", "Le franc"], correct: 2, explanation: "L'euro (€) depuis 2002 en Belgique." },
    { q: "Le saxophone a été inventé par un Belge. Dans quelle ville est-il né ?", choices: ["Bruxelles", "Liège", "Dinant", "Mons"], correct: 2, explanation: "Adolphe Sax est né à Dinant en 1814." },
    { q: "Jacques Brel était un célèbre artiste belge. Que faisait-il ?", choices: ["De la peinture", "De la chanson", "De l'architecture", "De la BD"], correct: 1, explanation: "Jacques Brel est l'un des plus grands chanteurs francophones." },
    { q: "Quel est l'hymne national de la Belgique ?", choices: ["La Marseillaise", "La Brabançonne", "L'Internationale", "God Save the King"], correct: 1, explanation: "La Brabançonne, composée pendant la révolution de 1830." },
    { q: "Quelle est la devise de la Belgique ?", choices: ["Liberté, Égalité, Fraternité", "L'union fait la force", "Dieu et mon droit", "Je maintiendrai"], correct: 1, explanation: "« L'union fait la force » en français, « Eendracht maakt macht » en néerlandais." },
    { q: "Quel océan borde la côte ouest de l'Europe ?", choices: ["L'océan Pacifique", "L'océan Indien", "L'océan Atlantique", "L'océan Arctique"], correct: 2, explanation: "L'océan Atlantique borde l'Europe à l'ouest." },
    { q: "Quel continent se trouve au sud de l'Europe, de l'autre côté de la Méditerranée ?", choices: ["L'Amérique", "L'Asie", "L'Afrique", "L'Océanie"], correct: 2, explanation: "L'Afrique est séparée de l'Europe par la mer Méditerranée." },
    { q: "Quel roi belge a abdiqué en 2013 en faveur de son fils Philippe ?", choices: ["Baudouin", "Léopold III", "Albert II", "Léopold II"], correct: 2, explanation: "Albert II a abdiqué le 21 juillet 2013." },
    { q: "La côte belge mesure environ combien de kilomètres ?", choices: ["27 km", "47 km", "67 km", "97 km"], correct: 2, explanation: "La côte belge fait environ 67 km, de La Panne à Knokke." },
    { q: "Quelle ville belge est surnommée « la Cité ardente » ?", choices: ["Bruxelles", "Namur", "Liège", "Charleroi"], correct: 2, explanation: "Liège est surnommée la Cité ardente." },
    { q: "Quelle ville belge est célèbre pour ses diamants ?", choices: ["Bruxelles", "Anvers", "Gand", "Bruges"], correct: 1, explanation: "Anvers est la capitale mondiale du diamant." },
    { q: "Quelle ville belge est surnommée « la Venise du Nord » ?", choices: ["Bruxelles", "Anvers", "Gand", "Bruges"], correct: 3, explanation: "Bruges, grâce à ses canaux." },
    { q: "En quelle année l'homme a-t-il marché sur la Lune pour la première fois ?", choices: ["1959", "1965", "1969", "1975"], correct: 2, explanation: "Neil Armstrong, le 20 juillet 1969 (mission Apollo 11)." },
    { q: "La chute du mur de Berlin a eu lieu en quelle année ?", choices: ["1979", "1985", "1989", "1991"], correct: 2, explanation: "Le mur de Berlin est tombé le 9 novembre 1989." },
    { q: "Qui a inventé l'imprimerie en Europe vers 1450 ?", choices: ["Léonard de Vinci", "Gutenberg", "Galilée", "Copernic"], correct: 1, explanation: "Johannes Gutenberg a inventé l'imprimerie à caractères mobiles." },
    { q: "Quelle civilisation ancienne a construit les pyramides en Égypte ?", choices: ["Les Grecs", "Les Romains", "Les Égyptiens", "Les Perses"], correct: 2, explanation: "Les anciens Égyptiens, il y a environ 4 500 ans." },
    { q: "Quel peuple vivait en Belgique avant l'arrivée des Romains ?", choices: ["Les Vikings", "Les Gaulois", "Les Francs", "Les Saxons"], correct: 1, explanation: "Les Gaulois (dont les Belges, un peuple gaulois qui a donné son nom au pays)." },
    { q: "Comment appelle-t-on la période entre l'Antiquité et les Temps modernes ?", choices: ["La Préhistoire", "Le Moyen Âge", "La Renaissance", "L'Époque contemporaine"], correct: 1, explanation: "Le Moyen Âge, environ du 5e au 15e siècle." },
];
